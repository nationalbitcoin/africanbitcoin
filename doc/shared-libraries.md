...
## africanbitcoinconsensus

The purpose of this library is to make the verification functionality that is critical to African Bitcoin's consensus available to other applications, e.g. to language bindings.

### API

The interface is defined in the C header `africanbitcoinconsensus.h` located in `src/script/africanbitcoinconsensus.h`.

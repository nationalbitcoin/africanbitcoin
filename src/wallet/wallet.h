...
private:
    ...
    void StakeAFBTCs(bool fStake, CConnman* connman, ChainstateManager* chainman, CTxMemPool* mempool);
...
public:
    ...
    SigningResult SignMessage(const std::string& message, const WitnessV0KeyHash& pkhash, std::string& str_sig) const;

...
const char * const BITCOIN_CONF_FILENAME = "africanbitcoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\africanbitcoin
    // macOS: ~/Library/Application Support/AfricanBitcoin
    // Unix-like: ~/.africanbitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "AfricanBitcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/AfricanBitcoin";
#else
    // Unix-like
    return pathRet / ".africanbitcoin";
#endif
#endif
}

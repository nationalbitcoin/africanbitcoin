...
public:
    CMainParams() {
        ...
        consensus.AFBTCColdStakeEnableHeight = 1;
        consensus.powLimit = arith_uint256("00000000000010c6f7a0b5ed8d36b4c7f34938583621fafc8b0079a2834d26fa"); // Hardcoded PoA bits are encoding difficulty 1000000.0
        consensus.posLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nTargetTimespan = 10 * 90; // every 10 blocks
        consensus.nTargetSpacing = 90; // 90 seconds or 1.5 minutes
        consensus.nMinipumPoASpacing = 3600; // One hour
        consensus.authorityID = CKeyID(uint160(ParseHex("f0b2075d9e7974d72ae18b5d2fae157dbd0ea99e"))); // Mainnet publisher id
...
public:
    CTestNetParams() {
        ...
        consensus.nMinerConfirmationWindow = 2016; // nTargetTimespan / nTargetSpacing
        consensus.MinBIP9WarningHeight = consensus.SegwitHeight + consensus.nMinerConfirmationWindow;
        consensus.AFBTCColdStakeEnableHeight = 2000;
